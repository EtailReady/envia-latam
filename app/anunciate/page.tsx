      ...
      <section className="section">
        <div className="container" style={{ maxWidth: '860px' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(240px, 1fr))', gap: '20px', marginBottom: '64px' }}>
            {[
              { name: 'Básico', price: 'Gratis', features: ['Perfil de empresa', '5 destinos', 'Información de contacto', 'Reseñas de clientes'], cta: 'Publicar gratis', accent: false },
              { name: 'Destacado', price: '$49/mes', features: ['Todo lo básico', 'Aparece primero en búsquedas', 'Banner promocional', 'Badge destacado', 'Hasta 20 destinos', 'Estadísticas de visitas'], cta: 'Empezar ahora', accent: true },
              { name: 'Premium', price: '$99/mes', features: ['Todo lo destacado', 'Homepage featured section', 'Logo en portada de país', 'Contacto directo WhatsApp prominente', 'Reseñas verificadas', 'Soporte prioritario'], cta: 'Contactar', accent: false },
            ].map(p => (
